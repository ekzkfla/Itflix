...
<body>
	...
	<from name="f" method="Post"> <c:forEach items="${movieList }"
		var="movie">
		<c:forEach items="${reviewTest1 }" var="review">
			<c:forEach items="${userSelectAll }" var="user_Info">
						...
						<div class="row ipad-width2">
							...
							<div class="col-md-7 col-sm-4 col-xs-3">
								<div class="movie-single-ct main-content">
									<!-- 영화 제목 -->
									<h1 class="bd-hd">
										${userSelectAll_u_email } Review List <span>2015</span>
									</h1>
									<!-- 상단바 -->
									<div class="movie-rate">
										<div class="rate">
											<p>
											<p>
												<span class="rv">${reviewCount} Reviews</span>
											</p>
											<!-- 총 리뷰 개수 -->
											</p>
										</div>
										...
										<div class="tabs">
											<div class="tab-content">
												...
												<div class="title-hd-sm">
													<h4>${reviewList.u_email }User reviews</h4>
												</div>
