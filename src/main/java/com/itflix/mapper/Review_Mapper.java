...
public interface Review_Mapper {
	...
	@Select("select  r.r_no, m.m_no, u.u_email, r.r_title, r.r_content, r.r_grade, r.r_date from review r left join user_info u on u.u_email = r.u_email left join movie m on m.m_no=r.m_no where m.m_no=6 order by r.r_date desc")
