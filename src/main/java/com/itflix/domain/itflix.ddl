...
ALTER TABLE Prefer ADD CONSTRAINT IDX_Prefer_FK0 FOREIGN KEY (u_email) REFERENCES User_Info (u_email);
...
ALTER TABLE Movie ADD CONSTRAINT IDX_Movie_FK0 FOREIGN KEY (cg_no) REFERENCES Category (cg_no);

ALTER TABLE Jjim ADD CONSTRAINT IDX_Jjim_FK0 FOREIGN KEY (u_email) REFERENCES User_Info (u_email);
ALTER TABLE Jjim ADD CONSTRAINT IDX_Jjim_FK1 FOREIGN KEY (m_no) REFERENCES Movie (m_no);
...
ALTER TABLE Review ADD CONSTRAINT IDX_Review_FK0 FOREIGN KEY (u_email) REFERENCES User_Info (u_email);
ALTER TABLE Review ADD CONSTRAINT IDX_Review_FK1 FOREIGN KEY (m_no) REFERENCES Movie (m_no);

ALTER TABLE Subscription ADD CONSTRAINT IDX_Subscription_PK PRIMARY KEY (s_no);
ALTER TABLE Subscription ADD CONSTRAINT IDX_Subscription_FK0 FOREIGN KEY (t_no) REFERENCES Ticket (t_no);
ALTER TABLE Subscription ADD CONSTRAINT IDX_Subscription_FK1 FOREIGN KEY (u_email) REFERENCES User_Info (u_email);
