...
--코미디
insert into movie values(MOVIE_M_NO_SEQ.nextval,'육사오','박규태,고경표,이이경,음문석 외 ','“45개 번호 중에 6개 맞히면 1등인 육사오라는 종이쪼가리, 내가 주웠지 말입니다” 우연히 1등 당첨 로또를 주운 말년 병장 천우. 심장이 터질듯한 설렘도 잠시, 순간의 실수로 바람을 타고 군사분계선을 넘어간 로또. 바사삭 부서진 멘탈을 부여잡고…기필코 다시 찾아야 한다! 우연히 남쪽에서 넘어온 1등 당첨 로또를 주운 북한 병사 용호. 이거이 남조선 인민의 고혈을 쥐어 짜내는 육사오라는 종이쪼가리란 말인가? 근데 무려 당첨금이 57억이라고?! 당첨금을 눈앞에서 놓칠 위기에 처한 ‘천우’와 북에선 한낱 종이쪼가리일 뿐일 로또를 당첨금으로 바꿔야 하는 용호. 여기에 예상치 못한 멤버들(?)까지 합류하고 57억을 사수하기 위한 3:3팀이 결성되는데… 주운 자 VS 또 주운 자 아슬아슬 선 넘는 지분 협상이 시작된다!','육사오.jpg',0,'2022.08.24','https://www.youtube.com/embed/v5aAR-',MOVIE_M_NO_SEQ.currval,1,0,2);
insert into movie values(MOVIE_M_NO_SEQ.nextval,'정직한 후보2','장유정,라미란, 김무열, 윤경호 외','거짓말 못하는 진실의 주둥이 컴백! 이번엔 2명?! 서울시장 선거에서 떨어지며 쫄딱 망한 백수가 된 주상숙은 우연히 바다에 빠진 한 청년을 구한 일이 뉴스를 타며 고향에서 화려한 복귀의 기회를 잡는다. 하지만 정직하면 할수록 바닥으로 곤두박질치는 지지율 앞에 다시 뻥쟁이로 돌아간 그 순간, 주상숙에게 운명처럼 찾아온 진실의 주둥이! 이번엔 주상숙의 비서실장 박희철까지 주둥이가 쌍으로 털리게 되는데... 재미도 2배! 웃음도 2배! 주둥이 대폭발 코미디가 돌아왔다!','이미지',0,'개봉일','url',MOVIE_M_NO_SEQ.currval,1,0,2);
